...
/*
 * Function: XmCountVaList
 *     
 * Description: Takes a variable list and returns the number of items in it. 
 *     
 ...
 */
int
XmCountVaList(va_list al)
{
    
   String at;
   int count = 0; 
   for(at = va_arg(al, String); 
       at != NULL;
       at = va_arg(al, String)) 
   {
        va_arg(al, XtArgVal);
