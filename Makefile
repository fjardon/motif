...
pkgdatadir = $(datadir)/openMotif
pkglibdir = $(libdir)/openMotif
pkgincludedir = $(includedir)/openMotif
...
AS = @AS@
CC = gcc
CDE_CONFIGURATION_TOP = NONE/etc/dt
CDE_INSTALLATION_TOP = NONE/dt
CPP = gcc -E
CURRENT = 3
DLLTOOL = @DLLTOOL@
ECHO = echo
...
STRIP = strip
VERSION = 3.30.1
XMBINDDIR_FALLBACK = ${exec_prefix}/lib/X11/bindings
XMTHEME_DIST = 
X_XMU = -lXmu
YACC = byacc

EXTRA_DIST = BUGREPORT CLOSEDBUGS COPYRIGHT.MOTIF Imakefile LICENSE OPENBUGS README README.ICS RELEASE RELNOTES openmotif-2.1.30.spec INSTALL.configure
